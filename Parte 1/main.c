...
volatile float execution_time = 0;
volatile float f_cpu = 180000000.0;
/* USER CODE END PV */
...
/**
  * @brief   Función para inicializar el módulo DWT
  * @retval None
  */
void DWT_Init(void) {
...
/**
  * @brief   Obtiene el valor actual del contador de ciclos
  * @retval °n CPI
  */
uint32_t DWT_GetCycles(void) {
    return DWT->CYCCNT;
